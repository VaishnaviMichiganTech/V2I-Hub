...
# Solidly fix Python interpreter path.
sed -e "/PYSHEBANG/s|@PYSHEBAG@|/usr/bin/python3|g" -i SConstruct

# Solidly fix icon path.
sed -e "/icon dir/s|share/gpsd/icons|%{_datadir}/gpsd|g" -i SConstruct
...
%files
%doc AUTHORS COPYING INSTALL.adoc README.adoc
...
%changelog
* Sun Feb 16 2020 James Browning <jamesb.fe80@gmail.com> - ????
