# Install script for directory: /home/vaishnavi/V2I-Hub/src/v2i-hub/CswPlugin
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xcswpluginx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/CSW/bin" TYPE EXECUTABLE PERMISSIONS OWNER_EXECUTE OWNER_WRITE OWNER_READ GROUP_EXECUTE GROUP_READ WORLD_EXECUTE WORLD_READ FILES "/home/vaishnavi/V2I-Hub/src/v2i-hub/bin/CswPlugin")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/CSW/bin/CswPlugin" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/CSW/bin/CswPlugin")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/CSW/bin/CswPlugin"
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xcswpluginx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/CSW" TYPE FILE PERMISSIONS OWNER_WRITE OWNER_READ GROUP_READ WORLD_READ FILES "/home/vaishnavi/V2I-Hub/src/v2i-hub/CswPlugin/manifest.json")
endif()
